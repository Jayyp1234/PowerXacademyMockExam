...
<section class="content-main">
	<div class="content-header1">
        <button type="button" class="btn btn-primary active">General</button>
        <button type="button" class="btn btn-light">API</button>
        <button type="button" class="btn btn-light">Webhooks</button>
	</div>
