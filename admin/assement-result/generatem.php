...
<div class="intro-div">
            <b>Generate Mid Semester Result for Student</b>
            <span id="time" class="time"></span>
        </div>
        <br>
        <form class="card container" method="POST" action="mid_result.php" style="padding:20px 30px">
        <div class="md-3">
        ...
        <label for="exampleDataList2" class="form-label">Students</label>
            <input class="form-control" name="name" list="datalistOptions2" id="exampleDataList2" placeholder="Type to search...">
