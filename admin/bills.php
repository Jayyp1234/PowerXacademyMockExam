...
<head>
    ...
    <title>PowerX Online Academy - Bills</title>
...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(!empty(test_input($_POST['price']))  ){
        ...
        $price = $_POST['price'];
        $span = $_POST['span'];
        $sql = "UPDATE `classes` SET `title`='$name', `price`= '$price', `span`='$span' WHERE id= '$id'";
        if($conn->query($sql)){
                ...
                $query = mysqli_query($conn,$sql);
                 if($query){
                     ...
                     while($row = mysqli_fetch_assoc($query)){
                         ...
                         <td>".$row['span']." months</td>
                         <td class='text-end'> 
                            <div class='dropdown'>
                                <a href='#' data-bs-toggle='dropdown' class='btn btn-light'> <i class='material-icons md-more_horiz'></i> </a> 
                                <div class='dropdown-menu'>
                                <a class='dropdown-item' href='#' data-bs-toggle='modal' data-bs-target='#exampleModal".$row['id']."'>Update</a>
                            </div>
                        </div> <!-- dropdown //end -->
                        </td> 
                   </tr>
                  <div class='modal fade' id='exampleModal".$row['id']."' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        ...
                        <div class='modal-header'>
                            <h5 class='modal-title' id='exampleModal".$row['id']."Label'>".strtoupper($row['title'])." Details</h5>
                        ...
                        <form method='POST'>
                            ...
                            <div class='mb-3'>
                                ...
                                <input type=text' name='name' value='".$row['title']."' class='form-control'>
                            </div>
                            <div class='mb-3'>
                            ...
                            <div class='mb-3'>
                                ...
                                <input type=text' name='span' value='".$row['span']."' class='form-control'>
                            </div>
                     ...
                     $output = '<b>You do not have any Results Yet</b>';
                 }
                 echo $output."</tbody>";
                 }
