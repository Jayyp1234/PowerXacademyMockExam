...
<section class="content-main">
	...
	<div class="row">
            <div class="card col-xl-3 col-sm-12">
                <div class="card-body" style="text-align:center"> 
                    <h6 class="card-subtitle mb-2 text-muted" style="system-ui">Legder Balance</h6>
                    <h1 class="card-title" style="font-weight:900"><small style="font-size: 12px;">NGN</small>6000</h1>
                </div>
            </div>
            <div class="card col-xl-3 col-sm-12">
                <div class="card-body" style="text-align:center"> 
                    <h6 class="card-subtitle mb-2 text-muted" style="system-ui">Available Balance</h6>
                    <h1 class="card-title" style="font-weight:900"><small style="font-size: 12px;">NGN</small>6000</h1>
                </div>
            </div>
            <div class="card col-xl-3 col-sm-12">
                <div class="card-body" style="text-align:center"> 
                    <h6 class="card-subtitle mb-2 text-muted" style="system-ui">Open</h6>
                    <h1 class="card-title" style="font-weight:900">43</h1>
                </div>
            </div>
            <div class="card col-xl-3 col-sm-12">
                <div class="card-body" style="text-align:center"> 
                    <h6 class="card-subtitle mb-2 text-muted" style="system-ui">On hold</h6>
                    <h1 class="card-title" style="font-weight:900">64</h1>
                </div>
            </div>
	</div> 
