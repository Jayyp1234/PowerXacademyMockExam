...
<head>
    ...
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
	  <title>PowerX Online Digital Academy - Upload Exams </title>
...
<div class="intro-div">
            <b>Upload Exam Result for Class</b>
            <span id="time" class="time"></span>
        </div>
        <br>
        <form class="card container" method="POST"  action="upload_id.php" style="padding:20px 30px">
        <div class="md-3">
