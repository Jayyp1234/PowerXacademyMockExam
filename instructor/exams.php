...
<head>
  ...
  <title>Power X Academy - Exams </title>
  ...
  function test_input($data) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
        if(!empty($_GET['id'])){
            ...
            $id = $_GET['publish'];
            $emailcheck = "UPDATE `exams` SET `published`='yes' WHERE id = '$id' ";
      ...
      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
            type="button" role="tab" aria-controls="pills-home" aria-selected="true">Drafts</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
            type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Published</button>
        </li>
      </ul>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example" class="display" style="width:100%">
                  <?php
                include '../backend_data/init.php';
                $sql = "SELECT * FROM `exams` WHERE published = 'no'";
                         ...
                         <td class='text-end'> 
                            <div class='dropdown'>
                                ...
                                <div class='dropdown-menu'>
                                    <a class='dropdown-item text-primary' href='exams.php?publish=".$row['id']."'>Publish</a>
